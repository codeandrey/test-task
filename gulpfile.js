...
gulp.task('sass', function() {
	...
	.pipe(gulp.dest(pathsrc+'/app/assets/css'))
...
gulp.task('scripts', function() {
	...
	.pipe(uglify())
	.pipe(gulp.dest(pathsrc+'/app/assets/js'))
	.pipe(browserSync.reload({stream: true}));
});
...
gulp.task('imagemin', function() {
	...
	.pipe(cache(imagemin()))
	.pipe(gulp.dest(pathsrc+'/app/assets/img')); 
});
...
gulp.task('fonts', function() {
    gulp.src(pathsrc+'/src/fonts/*')
        .pipe(gulp.dest(pathsrc+'/app/assets/fonts/'))
});
...
gulp.task('libs', function() {
    gulp.src(pathsrc+'/src/libs/*')
        .pipe(gulp.dest(pathsrc+'/app/assets/libs/'))
});
...
gulp.task('build', ['deletedist', 'imagemin', 'sass', 'scripts' ], function() {
	...
	var buildCss = gulp.src([
		pathsrc+'/app/assets/css/*',
	]).pipe(gulp.dest(pathsrc+'/dist/assets/css'));

	var buildJs = gulp.src([
		pathsrc+'/app/assets/js/scripts.min.js'
	]).pipe(gulp.dest(pathsrc+'/dist/assets/js'));

	var buildFonts = gulp.src([
		pathsrc+'/app/assets/fonts/**/*'
	]).pipe(gulp.dest(pathsrc+'/dist/assets/fonts'));
	
	var buildFonts = gulp.src([
		pathsrc+'/app/assets/libs/**/*'
	]).pipe(gulp.dest(pathsrc+'/dist/assets/libs'));
	
	var buildImage = gulp.src([
		pathsrc+'/app/assets/img/**/*'
